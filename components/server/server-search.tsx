...
export const ServerSearch = ({ data } : ServerSearchProps) => {
    ...
    return (
        <>
            <button onClick={() => setOpen(true)} className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hovver:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition">
